...
Later pushed docs-only UI-2 static mockup governance milestone now present on `main`:
...
- Figma use
- Stitch use
- ChatGPT UI/mockup generation
- MCP use
- AI/external design-tool use
...
| UI-2 | Static mockup governance boundary only | A future separately approved static mockup pass may clarify review experience without routes, runtime, data flow, or operator behavior. |
...
- [UI-2 static mockup governance decision record](./decision-records/agent-builder-ui2-static-mockup-governance.v0.1.md)
...
- [UI-2 static mockup governance decision record](./decision-records/agent-builder-ui2-static-mockup-governance.v0.1.md)
  as a completed docs-only planning governance dependency. This remains planning-only, proposed-for-human-review, and
  does not approve mockup creation, Figma use, Stitch use, ChatGPT UI/mockup generation, MCP use, AI/external
  design-tool use, UI-3 local read-only reviewer cockpit prototypes, UI-4 operator workflow planning, UI-5
...
This does not permit capability expansion and does not approve mockup creation, Figma use, Stitch use, ChatGPT
UI/mockup generation, MCP use, AI/external design-tool use, UI-2 static review mockups/prototypes, UI-3 local
read-only reviewer cockpit prototypes, UI-4 operator workflow planning, UI-5 implementation, runtime/model behavior,
Drive behavior, source reads, persistence/logging, automation, operational approval, or production readiness. Each
